...
export const SUCCESS_METRIC_CONFIG: SuccessMetricConfig[] = [
  ...
  { workspaceSlug: "larsen-digital",     successLabel: "Meetings Booked", successType: "airtable_date", baseId: "appV8wpBdqTgCi4Ws", tableId: "tblCATnaPTV9fb2Ab", field: "Meeting booked date", filter: `{Deal Source} = "Cold email (LD)"` },

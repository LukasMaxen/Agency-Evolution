# Reply Management — AI Guidelines

## Where AI Is Used in Reply Management
...
1. **Match the client's tone** — formal vs. conversational is defined per client in `campaign-strategy/[client].md`
2. **Keep it short** — 3–5 sentences unless the lead asked a specific question
3. **Use first name** — always personalize
4. **Include Calendly link** for interested leads — pull from `client-management/client-profiles.md`
...
- `/api/analyze/route.ts` — server-side route that calls Anthropic API directly
...
For guidance on building new AI features, see `operations/ai-framework.md`.

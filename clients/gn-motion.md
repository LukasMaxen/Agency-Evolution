...
manual_booking_trigger: false (reverted to standard flow 2026-09-07, see [[feedback_full_automation_clients]]. Was fully automated 2026-08-17 through 2026-09-07, same pattern as Larsen Digital. Note: no iClosed webhook exists in this app, see [[project_gn_motion_iclosed_gap]] — if a lead confirms they booked, set flag_meeting_booked true and send a short confirmation, not a new booking link.)
fully_automated: false (reverted 2026-09-07: back on the standard flow, every interested/needs_info reply goes to #reply-approval, a time-window ask goes to #manual-replies, same as the non-fully-automated clients)
